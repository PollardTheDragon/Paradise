...
GLOBAL_LIST_INIT(supply_bounties, list(
	...
	new /datum/supply_bounty(/obj/item/stack/medical/burn_pack	TRUE,		SUPPLY_BOUNTY_QUANTITY_MEDIUM,		SUPPLY_BOUNTY_REWARD_MEDIUM),
	...
	new /datum/supply_bounty(/obj/item/reagent_containers/bottle,		TRUE,	SUPPLY_BOUNTY_QUANTITY_HIGH,	SUPPLY_BOUNTY_REWARD_CHEAP),
	...
	new /datum/supply_bounty(/obj/item/restraint/handcuffs,	TRUE,		SUPPLY_BOUNTY_QUANTITY_HIGH,		SUPPLY_BOUNTY_REWARD_CHEAP),
